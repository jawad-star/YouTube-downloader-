...
function preview(){
  if(YouTube.value.indexOf("https://youtu.be/") != -1){
    ...
    document.querySelector('.result1').innerHTML = `<iframe style="background-color: #1f54c8;" width="100%" height="190" src="${url1}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`
  }
    ...
    document.querySelector('.result1').innerHTML = `<iframe style="background-color: #1f54c8;" width="100%" height="190" src="${urlSe}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
  }
}
  ...
  if(YouTube.value!=""){
    switch (format.value){
      case "Thumbnail":
         ...
         document.querySelector('.result2').innerHTML = `<button class="Get" style="border-radius:20px" onclick="download()">Download Video Thumbnail</button>`;
      break;
      case "mp3":
         hidden.classList.add('active');
         result1.classList.add('active');
         var url2 = `https://loader.to/api/button/?url=https://youtu.be/${Idurl.value}&f=mp3`;
         document.querySelector('.result2').innerHTML = `<button class="Get" style="border-radius:20px" scrolling="no" src="${url2}">Mp3</button>`;
         preview();
      break;
      case "m4a":
         hidden.classList.add('active');
         ...
         document.querySelector('.result2').innerHTML = `<iframe style="border-radius:15px;width:100%; height:45px;border:hidden;overflow:hidden;" scrolling="no" src="${url2}"></iframe>`;
         preview();
      break;
      case "360":
         hidden.classList.add('active');
    ...
    Swal.fire('Enter Your YouTube Url')
  }
}
